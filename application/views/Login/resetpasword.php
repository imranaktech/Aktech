...
<div class="wrapper">
  ...
  <div class="panel-heading border login_heading">Set Password</div>	
 ...
 <form action="<?php echo base_url();?>LoginCI/resetpasword" role="form" class="form-horizontal" method="post">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="password" placeholder="New Password" id="inputEmail3" class="form-control" name="npassword"><br>
        </div>
        <div class="col-sm-10">
          <input type="password" placeholder="Confirm Password" id="inputEmail3" class="form-control" name="cpassword">
        </div>
      </div>
        ...
        <div class=" col-sm-10">
          <div class="checkbox checkbox_margin">
            <label class="lable_margin">
              <a href="index.html">
              <button class="btn btn-default pull-right" type="submit" style="margin-left: 170px">Submit</button>
              </a></div>
