...
<div class="wrapper">
  ...
  <div class="panel-heading border login_heading">Forget Password</div>	
 ...
 if($this->session->flashdata('msg'))
 {
  ...
  ?>
 <form action="<?php echo base_url();?>LoginCI/sendmail" role="form" class="form-horizontal" method="post">
