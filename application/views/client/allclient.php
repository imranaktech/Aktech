        ...
        <div class="col-md-12">
          <div class="block-web">
            <div class="header">
              ...
              <h3 class="content-header">Clients Table</h3>
            </div>
         <div class="porlets-content">
          <div class="adv-table editable-table ">
                          <div class="clearfix">
                              <div class="btn-group">
                                  <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url('ClientC/insert')?>">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="client_datatable">
                              <thead>
                              <tr>
                                  <th>Full Name</th>
                                  <th>phone #</th>
