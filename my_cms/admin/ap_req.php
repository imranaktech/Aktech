...
<?php require_once('inc/nav.Php'); ?>
		...
		<div class="col-md-9"><!-- note this is coontent area start -->
			<h2><i class="fa fa-envelope-open  text text-primary"> Aproved Contact Requests</i> <small>Users Intrusted toward you.</small></h2> <hr>
			<div class="breadcrumb">
				 <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-envelope-open"></i> Aproved Contact Request
                                    </li>
                                </ol>
...
<div class="col-md-10">
                           <h2 class="text text-primary">Peoples Aproved Contact Requests*:</h2><hr>
...
<?php 
 ...
 ?>
    ...
    <?php 
            ...
            $query="SELECT * FROM contact WHERE status='publish' ORDER BY id DESC";
            ...
            echo "<tr>
                        ...
                        <td>$email</td>
                        <td>$message</td>
                        <td><button type='submit' name='edit' class='btn btn-success'><a href='show.php?apr=$id'><i class='fa fa-envelope-open'></i> Un Aproove </a></button></td>


                        <td><button type='submit' name='delete' class='btn btn-danger'><a href='delete.php?ar=$id'><i class='fa fa-trash'></i> Delete</a></button></td>
