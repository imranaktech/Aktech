...
<?php require_once('inc/nav.Php'); ?>
		...
		<div class="col-md-9"><!-- note this is coontent area start -->
			<h2><i class="fa fa-eye  text text-primary"> Visible Comments</i> <small>Comments are the users feed back.</small></h2> <hr>
...
<?php 
 ...
 ?>
    ...
    <?php 
            ...
            $query="SELECT * FROM comment WHERE status='publish' ORDER BY id DESC";
            ...
            echo "<tr>
                        ...
                        <td>$categories</td>
                        <td>$message</td>
                        <td><button type='submit' name='edit' class='btn btn-success'><a href='hide.php?com=$id'><i class='fa fa-eye-slash'></i> Hide </a></button></td>


                        <td><button type='submit' name='delete' class='btn btn-danger'><a href='delete.php?vdc=$id'><i class='fa fa-trash'></i> Delete</a></button></td>
