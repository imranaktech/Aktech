<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container nine">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">
              ...
              <div class="col-xs-9">Ali champ</div>
          </a>
        </div>
 ...
 Home</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" id="navbarDropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list-alt"></i>
 ...
 Contact Us</a></li>
 <li><a href="admin/"><i class="fa fa-sign-in"></i>
Admin  Login</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
